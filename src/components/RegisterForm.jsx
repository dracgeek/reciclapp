...
class RegisterForm extends React.Component {
  ...
  async componentDidMount() {
    const res = await axios.get(
      "http://localhost:4000/api/usersForm/typeDocuments"
    );
    const res2 = await axios.get(
      "http://localhost:4000/api/usersForm/neighborhoods"
    );
          ...
          <div className="row">
            <div className="col overflow-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <div className="form-group row">
                  <div className="col-12">
                    ...
                    <input
                      ...
                      onChange={this.onSelectAndInputChange}
                      type="text"
                ...
                <button
                  type="submit"
                  className="form-control btn btn-lg btn-siguiente"
                  name="Siguiente"
                >
                  Registrarse
                </button>
                <div className="form-group row d-flex justify-content-center">
                  <Link to="/RegisterOne">
                    <button
                      type="button"
                      className="form-control btn btn-lg btn-regresar"
                      name="Regresar"
                    >
                      Regresar
                    </button>
